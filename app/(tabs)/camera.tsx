// Надо установить: "expo-media-library", "expo-image-picker", "expo-file-system"
...
export default function CameraExpoScreen() {
  ...
  // ---- Permissions (Expo-managed) ----
  const ensureCameraPermission = async () => {
    const { status } = await ImagePicker.requestCameraPermissionsAsync();
    return status === "granted";
  };

  // ВАЖНО: на ANDROID не запрашиваем write-права у MediaLibrary — Expo Go не имеет нужных записей в манифесте.
  const ensureLibraryPermission = async (write = false) => {
    ...
    return true; // Android: достаточно
  };
